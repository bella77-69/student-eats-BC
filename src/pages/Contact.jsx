...
export default function Contact() {
  ...
  return (
    <div className="bg-gray-200 px-6 py-24 sm:py-32 lg:px-8 ">
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-3xl font-bold tracking-tight text-slate-800 shadow-slate-200sm:text-4xl">
          Contact Student Eats BC
        </h2>
        <p className="mt-2 text-lg leading-8 text-gray-600">
          Have a question? Want to learn more about our services? Fill out the
